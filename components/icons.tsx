...
export const WandSparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m22 11-1-1-3.5-3.5-1-1-3.5-3.5-1-1a2.5 2.5 0 1 0-4 4l9 9" /><path d="m18 13 1 1 3.5 3.5 1 1 3.5 3.5 1 1" /><path d="M12.5 2.5 11 4" /><path d="m21.5 13.5-1.5 1.5" /><path d="m13.5 21.5-1.5-1.5" /><path d="M4 11l1.5-1.5" /><path d="M2.5 12.5 4 11" />
  </svg>
);
...
export const Volume1Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
    <path d="M15.54 8.46a5 5 0 0 1 0 7.07" />
  </svg>
